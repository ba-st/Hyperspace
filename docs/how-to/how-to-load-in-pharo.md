# How to load Hyperspace in a Pharo image
...
5. Select *Clone from github.com* and enter `ba-st` as owner name and `Hyperspace`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Hyperspace ...*
